...
class SimpleGANTrainer:
    '''
    Perform Simple GAN training

    Simple GAN Training algorithm is as follows:
        ...
        While no. of samples in labelled pool less than n_samples_end, repeat:
            Repeat until 10 images synthesised:
                1) Synthesise image using GAN
                2) Oracle labels synthesised image
                3) Add synthesised and labelled image to labelled pool
            1) Update learner
    ...
    def traingaal(self, n_samples_end, x_train, y_train, x_test, y_test):
        ...
        while n_samples_this < n_samples_end:
            ...
            while cnt < 10:
                ...
                zt = np.random.randn(self.latent_dim).reshape((1,-1))
